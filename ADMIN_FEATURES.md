...
**Catatan Penting:**
- ⚠️ Hash SHA-256 **TIDAK DAPAT** diubah (read-only)
...
- ⚠️ Verifikasi akan gagal (QRIS tidak dikenali)
...
- ⚠️ Gunakan "Hapus Permanen" hanya jika benar-benar yakin
