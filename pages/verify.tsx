...
export default function Verify() {
  ...
  const [scannedMerchantInfo, setScannedMerchantInfo] =
    useState<QRISMerchantInfo | null>(null);

  const handleScan = async (data: string, merchantInfo?: QRISMerchantInfo) => {
    setLoading(true);
    setResult(null);
    setScanError("");
    setRawData(data);
    setScannedMerchantInfo(merchantInfo || null);
    try {
          ...
          <AnimatePresence mode="wait">
            {!result && !loading && (
              ...
              >
                ...
                >
                  Arahkan kamera ke QRIS merchant atau upload foto QRIS dari
                  galeri Anda
                </p>
            ...
            {loading && (
              ...
              >
                ...
                {/* Show scanned merchant info during loading */}
                {scannedMerchantInfo && (
                  <motion.div
                ...
                {result.verified ? (
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        QRIS ini aman dan terdaftar. Transaksi dapat
                        dilanjutkan.
                      </motion.p>
                    </div>
                    ...
                    >
                      ...
                      {[
                        ...
                        {
                          label: "Terdaftar",
                          val: result.merchant?.registeredAt
                            ? new Date(
                                result.merchant.registeredAt,
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        di database kami. Segera beritahu kasir atau batalkan
                        transaksi.
                      </p>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <span>
                          <strong>Peringatan Keamanan:</strong> Jangan lanjutkan
                          transaksi sebelum memverifikasi keaslian QRIS ini
                          dengan pihak merchant atau pengelola.
                        </span>
                      </p>
                    </div>
        ...
        {!result && !loading && (
          ...
          >
            ...
            >
              <Lightbulb
                size={16}
                style={{ flexShrink: 0, marginTop: "2px", color: "#fff985" }}
              />
              <span>
                <strong style={{ color: "rgba(255,255,255,0.6)" }}>
                  Tips:
                </strong>{" "}
                Pastikan gambar QRIS tidak buram dan seluruh kode terlihat jelas
