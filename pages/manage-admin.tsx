...
export default function ManageAdmin() {
  ...
  const checkAuth = async () => {
    try {
      ...
      if (userData.role !== 'superadmin' || !userData.is_active) {
        alert('Akses ditolak. Hanya superadmin yang dapat mengakses halaman ini.')
        router.push('/dashboard')
        return
      }
  ...
  return (
    <>
      <Head>
        <title>Manage Admin — DecoQ</title>
      </Head>
      ...
      <div style={{
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
            <div style={{
              ...
              <Shield size={24} color="#fff985" strokeWidth={2.5} />
            </div>
            <div>
              <h1 style={{ color: '#fff', fontWeight: 800, fontSize: '1.8rem', margin: 0 }}>
                Manage Admin
              </h1>
        ...
        <motion.div
          ...
          className="glass"
          style={{ padding: '1.5rem', borderRadius: '16px', marginBottom: '1.5rem' }}
        >
          <div style={{ 
            display: 'flex', 
            flexWrap: 'wrap',
