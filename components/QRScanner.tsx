...
interface QRScannerProps {
  onScan: (data: string, merchantInfo?: QRISMerchantInfo) => void;
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (code?.data) {
        ...
        // Extract merchant info if valid QRIS
        let merchantInfo: QRISMerchantInfo | undefined;
        if (isValidQRIS(code.data)) {
          merchantInfo = extractQRISMerchantInfo(code.data);
        }

        onScan(code.data, merchantInfo);
        return;
      }
      animRef.current = requestAnimationFrame(tick);
    };
  ...
  const handleFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    img.onload = async () => {
      ...
      if (code?.data) {
        ...
        onError?.(
          "QR Code tidak ditemukan dalam gambar. Coba gambar yang lebih jelas.",
        );
      }
    };
    e.target.value = "";
              ...
              <div style={{ position: "relative", width: 180, height: 180 }}>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    right: 0,
                    borderTop: "3px solid #fff985",
                    borderRight: "3px solid #fff985",
                    borderRadius: "0 4px 0 0",
                  },
                  {
                    bottom: 0,
                    left: 0,
                    borderBottom: "3px solid #fff985",
                    borderLeft: "3px solid #fff985",
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    height: 2,
                    background:
                      "linear-gradient(90deg, transparent, #fff985, transparent)",
